...
const card = [
  { name: "Location", icon: IconMapPin, id: "location" },
  { name: "Experience", icon: IconBriefcase, id: "experience" },
  { name: "Salary", icon: IconPremiumRights, id: "packageOffered" },
  { name: "Job Type", icon: IconRecharging, id: "jobType" },
];
